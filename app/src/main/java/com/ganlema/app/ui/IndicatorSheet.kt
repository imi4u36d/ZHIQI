...
fun IndicatorSheet(
    ...
    Column(
        ...
        Row(
            ...
            Text("取消", color = Color(0xFF666D79), modifier = Modifier.noRippleClickable(onCancel))
            Text("今日${metricTitle(metricKey)}", style = MaterialTheme.typography.titleLarge, color = Color(0xFF2F3440))
            Text(
                "确定",
                color = accent,
        ...
        if (metricKey == "体温" || metricKey == "体重" || metricKey == "日记") {
            Column(
                modifier = Modifier
                    ...
                    .border(1.dp, Color(0xFFF0E7EC), RoundedCornerShape(22.dp))
                    .padding(16.dp),
                verticalArrangement = Arrangement.spacedBy(12.dp)
            ) {
                Text(metricTitle(metricKey), style = MaterialTheme.typography.titleMedium, color = Color(0xFF2F3440))
                OutlinedTextField(
                    value = customValue,
                    onValueChange = {
...
private fun IndicatorChoice(
    ...
    Box(
        modifier = modifier
            .background(if (selected) accent.copy(alpha = 0.15f) else Color(0xFFFFFBFD), RoundedCornerShape(18.dp))
            .border(1.dp, if (selected) accent else Color(0xFFF0E7EC), RoundedCornerShape(18.dp))
        ...
        Text(
            text,
            color = if (selected) accent else Color(0xFF596171),
